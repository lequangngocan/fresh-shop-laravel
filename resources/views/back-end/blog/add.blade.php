    ...
    @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Tiêu đề tin tức" name="news_title" value="{{ old('news_title') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="news_image" value="{{ old('news_image') }}">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="news_detail" name="news_detail">{!! old('news_detail') !!}</textarea>

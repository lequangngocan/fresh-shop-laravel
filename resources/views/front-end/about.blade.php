...
@section('title','About Us | Lê Quang Ngọc An')
@section('content')
    <!-- Start All Title Box -->
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="front-end/images/about-img.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <center>
                    <div class="col-sm-6 col-lg-3">
                        <div class="hover-team">
                            <div class="our-team"> <img src="front-end/images/img-4.jpg" alt="" />
                                <div class="team-content">
                                    <h3 class="title">Le Quang Ngoc An</h3> <span class="post">Web Developer</span> </div>
                                <ul class="social">
                                    <li>

...
@section('title','Contact Us | Lê Quang Ngọc An')
@section('content')
    <!-- Start All Title Box -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="full_name" placeholder="Your Name" value="{{old('full_name')}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Your Email" id="email" class="form-control" name="email" value="{{old('email')}}">
                                        @if($errors->has('email'))
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('subject'))
                                            <span style="color:red;font-size:15px">{{$errors->first('subject')}}</span>
                                        @endif
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('message'))
                                            <span style="color:red;font-size:15px">{{$errors->first('message')}}</span>
                                        @endif
                                        <div class="help-block with-errors"></div>
                                    </div>

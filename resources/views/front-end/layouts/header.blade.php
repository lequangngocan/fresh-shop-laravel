            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>Call US :- <a href="#"> +84 387 210 034</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
                ...
                <div class="our-link" style="float:right">
                        <ul>
                            <!-- <li><a href="#"><i class="fa fa-user s_color"></i> My Account</a></li>
                            <li><a href="#"><i class="fas fa-location-arrow"></i> Our location</a></li> -->
                            <!-- <li><a href="login-front-end">Sign in</a></li> -->
                            @if(Auth::check())
                                <li><a>{{ Auth::user()->user_name }}</a></li>
                                    <li><a href="{{URL::to('logout-front-end')}}">Đăng xuất</a></li>
                            @else
                                <li><a href="{{URL::to('login-front-end')}}">Đăng nhập</a></li>
                            @endif
                            @if(Auth::check())
                                @if(Auth::user()->role==1)
                                    <li><a href="{{URL::to('back-end/dashboard')}}">Quản trị</a></li>
                                @endif
                            @endif
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{URL::to('/')}}"><img src="front-end/images//logo.png" class="logo" alt=""></a>
                </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @foreach($categories as $category)
								    <li><a href="{{URL::to('/category/'.$category->id)}}">{{$category->category_name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    ...
                    @foreach(Cart::content() as $cart)
                        <li>
                            <a href="#" class="photo"><img src="{{ asset($cart->options->img) }}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">{{$cart->name}}</a></h6>
                            <p>{{$cart->qty}}x - <span class="price">${{ $cart->qty * $cart->price }}</span></p>
                        </li>
                    @endforeach
                        <li class="total">
                            <a href="view-cart" class="btn btn-default hvr-hover btn-cart">VIEW CART</a>
    ...
    <div class="top-search">
        <div class="container">
            <div class="input-group">
                ...
                @csrf
                    <input type="text" class="form-control" name="keyword" id="search" placeholder="Search" style="width:1000px">
                </form>
